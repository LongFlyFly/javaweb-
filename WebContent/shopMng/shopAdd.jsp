...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <form class="form-horizontal" action="${pageContext.request.contextPath }/shopAddSvlt">
            <div class="form-group">
            <label for="title" class="col-sm-2 control-label">商品名称</label>
                <input type="text" class="form-control" name="name" placeholder="标题请简明扼要"></input>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">商品内容</label>
                <div class="col-sm-10">
                    <textarea name="discrabe" class="form-control" rows="3"></textarea>
                    <input type="text" class="form-control" name="price" placeholder="价格"></input>
                    <input type="text" class="form-control" name="discount" placeholder="折扣价格"></input>
