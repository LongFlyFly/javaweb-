			...
			<table width="100%">
				...
				<tr align="center">
					<td>
						...
						<!--&yen表示人民币-->
						<p style="color: orange;">&yen 16  橙汁</p>
						<p>冬天里的第一杯温暖</p>
						<p style="color: gray;">送给你，温暖我</p>
						<a href="../index/index.jsp"><button style="color: red;" align="right">购买</button></a>
					</td>
					<td>
						<img src="../img/果2.jpg" width="150px"/><br/>
						<!--&yen表示人民币-->
						<p style="color: orange;">&yen 12  三剑客</p>
						<p>你的心情</p>
						<p style="color: gray;">喜上眉梢</p>
					<a href="../index/index.jsp"><button style="color: red;"align="right">购买</button></a>
					</td>
					<td>
						<img src="../img/果3.jpg" width="150px"/><br/>
						<!--&yen表示人民币-->
						<p style="color: orange;">&yen 13  苹果汁</p>
						<p>苹果的味道</p>
						<p style="color: gray;">喝了才知道</p>
						<a href="../index/index.jsp"><button style="color: red;"align="right">购买</button></a>
					</td>
					<td>
						<img src="../img/果4.jpg" width="150px"/><br/>
						<!--&yen表示人民币-->
						<p style="color: orange;">&yen 20  青柠汁</p>
						<p>你想要的青柠</p>
						<p style="color: gray;">我都有</p>
						<a href="../index/index.jsp"><button style="color: red;" align="right">购买</button></a>
					</td>
					<td>
						<img src="../img/果5.jpg" width="150px"/><br/>
						<!--&yen表示人民币-->
						<p style="color: orange;">&yen 12  三剑客2</p>
						<p>不一样的品牌</p>
				...
				<tr align="center">
					<td>
						<img src="../img/果6.jpg" width="150px"/><br/>
						<!--&yen表示人民币-->
						<p style="color: orange;">&yen 26 橙汁家族</p>
						<p>再看，再看</p>
						<p style="color: gray;">我就喝了你</p>
						<a href="../index/index.jsp"><button style="color: red;"align="right">购买</button></a>
					</td>
					<td>
						<img src="../img/果7.jpg" width="150px"/><br/>
						<!--&yen表示人民币-->
						<p style="color: orange;">&yen 15 蜜茶</p>
						<p>不仅好看</p>
					...
					<td>
						...
						<!--&yen表示人民币-->
						<p style="color: orange;">&yen 13 奶汁</p>
						<p>牛奶？</p>
						<p style="color: gray;">不，是果汁</p>
						<a href="../index/index.jsp"><button style="color: red;"align="right">购买</button></a>
					</td>
					<td>
						<img src="../img/果9.jpg" width="150px"/><br/>
						<!--&yen表示人民币-->
						<p style="color: orange;">&yen 14 一杯果汁</p>
						<p>好喝</p>
						<p style="color: gray;">品好</p>
						<a href="../index/index.jsp"><button style="color: red;"align="right">购买</button></a>
					</td>
					<td>
						<img src="../img/果10.jpg" width="150px"/><br/>
						<!--&yen表示人民币-->
						<p style="color: orange;">&yen 17 水果与汁</p>
						<p>你要的水果</p>
						<p style="color: gray;">配和着汁</p>
						<a href="../index/index.jsp"><button style="color: red;"align="right">购买</button></a>
					</td>
				</tr>		
			</table>
