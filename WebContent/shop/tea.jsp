...
<div id="main">
			...
			<table width="100%">
				...
				<tr align="center">
					<td>
						<img src="../img/茶1.jpg" width="150px"/><br/>
						<!--&yen表示人民币-->
						<p style="color: orange;">&yen 26  红茶</p>
						<p>冬天里的第一杯温暖</p>
						<p style="color: gray;">送给你，温暖我</p>
						<a href="../index/index.jsp"><button style="color: red;" align="right">购买</button></a>
					</td>
					<td>
						<img src="../img/茶2.jpg" width="150px"/><br/>
						<!--&yen表示人民币-->
						<p style="color: orange;">&yen 22  绿茶</p>
						<p>你的心情</p>
						<p style="color: gray;">喜上眉梢</p>
					<a href="../index/index.jsp"><button style="color: red;"align="right">购买</button></a>
					</td>
					<td>
						<img src="../img/茶3.jpg" width="150px"/><br/>
						<!--&yen表示人民币-->
						<p style="color: orange;">&yen 33  冰红茶</p>
						<p>红茶的味道</p>
					...
					<td>
						...
						<!--&yen表示人民币-->
						<p style="color: orange;">&yen 20  茉莉蜜茶</p>
						<p>你想要的蜜茶</p>
						<p style="color: gray;">我都有</p>
						<a href="../index/index.jsp"><button style="color: red;" align="right">购买</button></a>
					</td>
					<td>
						<img src="../img/茶5.jpg" width="150px"/><br/>
						<!--&yen表示人民币-->
						<p style="color: orange;">&yen 12  茉莉清茶</p>
						<p>不一样的品牌</p>
				...
				<tr align="center">
					<td>
						<img src="../img/茶6.jpg" width="150px"/><br/>
						<!--&yen表示人民币-->
						<p style="color: orange;">&yen 26 柚子茶</p>
						<p>再看，再看</p>
						<p style="color: gray;">我就喝了你</p>
						<a href="../index/index.jsp"><button style="color: red;"align="right">购买</button></a>
					</td>
					<td>
						<img src="../img/茶7.jpg" width="150px"/><br/>
						<!--&yen表示人民币-->
					...
					<td>
						<img src="../img/茶8.jpg" width="150px"/><br/>
						<!--&yen表示人民币-->
						<p style="color: orange;">&yen 13 绿仙子</p>
						<p>最浓的茶</p>
					...
					<td>
						<img src="../img/茶10.jpg" width="150px"/><br/>
						<!--&yen表示人民币-->
